...
INSERT INTO "new_ConsultantServiceConfig" ("audioRate", "consultantUserId", "easyPaisaAccount", "easyPaisaEnabled", "fileRate", "id", "imageRate", "jazzCashAccount", "jazzCashEnabled", "payFastEnabled", "payFastMerchantId", "payFastSecuredKey", "stripeAccountId", "stripeEnabled", "textRate", "videoRate") SELECT "audioRate", "consultantUserId", "easyPaisaAccount", "easyPaisaEnabled", "fileRate", "id", "imageRate", "jazzCashAccount", "jazzCashEnabled", "payFastEnabled", "payFastMerchantId", "payFastSecuredKey", "stripeAccountId", "stripeEnabled", "textRate", "videoRate" FROM "ConsultantServiceConfig";
