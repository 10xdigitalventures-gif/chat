...
export const creditsApi = {
  ...
  getHistory: (p, ps) =>
    api.get("/credits/history", { params: { page: p, pageSize: ps } }),
  ...
  purchaseEasyPaisaOtc: (body) =>
    api.post("/credits/purchase/easypaisa/otc", body),
...
export const reviewApi = {
  ...
  create: (consultantId, body) =>
    api.post(`/user/consultants/${consultantId}/reviews`, body),
  update: (consultantId, id, b) =>
    api.put(`/user/consultants/${consultantId}/reviews/${id}`, b),
  delete: (consultantId, id) =>
...
export const forgotApi = {
  ...
  reset: (email, resetSessionToken, pwd) =>
