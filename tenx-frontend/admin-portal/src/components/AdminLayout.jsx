...
import {
  ...
  FileDigit, Radio, ShieldCheck, Receipt, ChevronRight, Search
} from 'lucide-react'
    ...
    <div className="layout">
      <aside className="sidebar-premium">
        <div className="sidebar-logo-premium">
          ...
          <span style={{ fontSize: 10, marginLeft: 8, padding: '2px 6px', background: '#f1f3f5', borderRadius: 4, color: '#868e96', fontWeight: 700 }}>ADMIN</span>
        </div>
        ...
        <nav className="sidebar-nav-premium">
          ...
          <button className="sidebar-item-premium" onClick={handleLogout} style={{ color: '#fa5252' }}>
