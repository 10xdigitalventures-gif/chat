    ...
    <div className="login-page">
      <div className="login-box">
        <div className="login-logo">
          10X <span style={{ color: "var(--accent)" }}>Consultant</span>
        </div>
        ...
        <form onSubmit={submit}>
          <div className="form-group">
            ...
            <input
              ...
              placeholder="consultant@tenx.com"
              required
              autoFocus
            />
          </div>
        ...
        Promise.all([
          ...
          .then(([c, r, m]) =>
            setStats({
              ...
              unread: (m.data.data?.items || []).reduce(
    ...
    <>
      ...
      <div className="card">
        <p style={{ color: "var(--muted)", fontSize: 13 }}>
          Use the sidebar to manage your profile, view clients, handle
          connection requests, and chat with clients in real-time.
        </p>
      </div>
    </>
  );
        ...
        <div className="card">
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              placeholder="Strategic consulting services for..."
            />
          </div>
          <F
            name="specialization"
            label="Specialization"
            placeholder="Business Strategy, Finance..."
          />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: "var(--muted)" }}>
                  Allow clients to voice call you
                </div>
              </div>
            </div>
            <div
            ...
            >
              <label className="toggle">
                <input
                  type="checkbox"
                  checked={form.videoEnabled ?? false}
                  onChange={(e) =>
              ...
              <div>
                ...
                <div style={{ fontSize: 11, color: "var(--muted)" }}>
                  Allow clients to video call you
                </div>
              </div>
            </div>
          </div>
...
export function RequestsPage() {
  ...
  const load = async () => {
    setLoading(true);
    try {
      const { data } = await consultantApi.getRequests();
  ...
  return (
    <>
      ...
      <div className="card">
        {loading && (
          <p
            style={{ color: "var(--muted)", textAlign: "center", padding: 40 }}
          >
            Loadingâ€¦
          </p>
        )}
...
export function MessagingPage() {
  ...
  const [activeConv, setActiveConv] = useState(
    paramConvId && paramConvId !== "undefined" ? paramConvId : null,
  );
        ...
        <div style={{ padding: 12 }}>
          <div style={{ position: "relative" }}>
            ...
            <input
              ...
              style={{ paddingLeft: 32, height: 36, borderRadius: 4 }}
            />
          </div>
        </div>
        <div style={{ flex: 1, overflowY: "auto" }}>
          {filtered.map((c) => (
            <div
              ...
              className={`crm-chat-item ${activeConv === c.conversationId ? "active" : ""}`}
              onClick={() => {
          ...
          <>
            <div className="crm-chat-header">
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                >
                  {activeConvData.otherUserAvatar ? (
                    <img
                      src={activeConvData.otherUserAvatar}
                      alt="a"
                      style={{
                        width: "100%",
                        height: "100%",
                    ...
                    activeConvData.otherUserName.charAt(0)
                  )}
                </div>
                <div style={{ fontWeight: 700 }}>
                  {activeConvData.otherUserName}
                </div>
              </div>
              <div style={{ display: "flex", gap: 16, color: "#adb5bd" }}>
                <Phone size={18} />
                <Video size={18} />
                <Star size={18} />
                <Info size={18} />
            ...
            <div className="crm-chat-messages">
              ...
              {isTyping && (
                <div
                  style={{ fontSize: 12, color: "#228be6", marginBottom: 16 }}
                >
                  Typing...
                </div>
              )}
            ...
            <div className="crm-input-area">
              ...
              <div
                className="crm-input-box"
                style={{
                  borderRadius: replyTo || pendingFile ? "0 0 8px 8px" : "8px",
                }}
              >
                <textarea
                  value={text}
                ...
                <div className="crm-input-toolbar">
                  ...
                  <button
                    ...
                    disabled={sending}
                  >
                    {sending ? <Loader size={12} className="spin" /> : "Send"}
                  </button>
                </div>
                <input
                  type="file"
      ...
      {activeConvData && (
        <div className="crm-details-panel">
          ...
          <div className="crm-details-section">
            <div className="crm-details-title">Owner</div>
            <div
              style={{
                display: "flex",
                alignItems: "center",
          ...
          <div className="crm-details-section">
            <div className="crm-details-title">Details</div>
            <div className="crm-field">
              <label>First Name</label>
              <div>{activeConvData.otherUserName?.split(" ")[0]}</div>
            </div>
            <div className="crm-field">
              <label>Last Name</label>
              <div>{activeConvData.otherUserName?.split(" ")[1] || "--"}</div>
            </div>
            <div className="crm-field">
              <label>Email</label>
              <div>{activeConvData.otherUserEmail || "--"}</div>
            </div>
          </div>
          <div className="crm-details-section">
            <div className="crm-details-title">Tags</div>
            <div style={{ color: "#adb5bd", fontSize: 12 }}>No tags yet</div>
          </div>
        </div>
      )}
    </div>
